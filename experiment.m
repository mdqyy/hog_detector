function [accuracy] = experiment(blink_matrix,aam_path,descriptor,options,target_dimensions,k_fold,algorithm,ml_options)

% this produces the the matrix X which represents examples and Y which represents targets
[X,Y] = pre_processing(aam_path,blink_matrix,descriptor,options,target_dimensions);
